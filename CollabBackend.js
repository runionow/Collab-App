...
// This file has been taken from the ink & switch research which allows to seperate backend 
// activities from the middle ware
// This is an abstraction for hypercore for managin the storage
// All the copyright for the backend hypercore abstracts belongs to its creators

// hypercore = library basically used for managing the append only log
// discovery-swarm = webRTC enabled framwork for creating the broadcasting groups
// discovery-swarm-discocery = allows us to connect to signalling servers-in here i am using an opensource signalling server
// with few modification this project can be run with our signalling server
...
class CollabBackend extends EventEmitter {
